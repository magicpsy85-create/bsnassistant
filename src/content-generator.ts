...
10-2. [6장 포지션 중립]
  6장은 매수자·매도자 특정 포지션 관점이 아닌, 시장을 보는 범용 통찰 카드입니다.
  금지 용어: "매수", "매도", "진입", "정리", "정리 검토", "선점", "매도 타이밍", "매수 추천", "디딜물건", "매수 팁", "매도 팁"
  이 용어가 6장에 나오면 즉시 탈락. "놓치기 쉬운 포인트", "숫자 너머의 의미", "앞으로 주목할 변수" 프레임으로 관찰 톤 유지하세요.
